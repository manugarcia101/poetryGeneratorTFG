...
class Char_LSTM():
    ...
    def BuildModel(self):
        json_file = open(os.path.join(os.getcwd(), 'flaskblog/RNN/model-char-lstm.json'), 'r')
        loaded_model_json = json_file.read()
        json_file.close()
        loaded_model = model_from_json(loaded_model_json)
        # load weights into new model
        loaded_model.load_weights(os.path.join(os.getcwd(), 'flaskblog/RNN/model-char-lstm.h5'))
        return loaded_model
    ...
    def train_model(self):
        ...
        with open("model-char-lstm.json", "w") as json_file:
            json_file.write(model_json)
        # serialize weights to HDF5
        model.save_weights("model-char-lstm.h5")
